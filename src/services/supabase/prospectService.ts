...
import { extractDomain, getDomainCompany, getStatusColor, getRecommendedAction } from '@/utils/clientUtils';
import type { ProspectWithEngagement, ProspectProfile } from '@/services/types';
